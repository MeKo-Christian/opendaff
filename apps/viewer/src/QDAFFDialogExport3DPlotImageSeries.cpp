...
QDAFFDialogExport3DPlotImageSeries::QDAFFDialogExport3DPlotImageSeries(QWidget* parent, const QDir& oBasePath,
																	   const QString& sFileBaseName)
	: QDialog(parent), ui(new Ui::QDAFFDialogExport3DPlotImageSeries), m_oBasePath(oBasePath),
	  m_sFileBaseName(sFileBaseName), m_bExport(false)
{
	ui->setupUi(this);
...
void QDAFFDialogExport3DPlotImageSeries::LoadSettings()
{
	...
	ui->doubleSpinBox_AnimationPitchStart->setValue(
		qs.value("Export3DPlotImageSeries/AnimatePitchStart", 0.0f).toDouble());
	ui->doubleSpinBox_AnimationPitchEnd->setValue(qs.value("Export3DPlotImageSeries/AnimatePitchEnd", 0.0f).toDouble());
	ui->spinBox_AnimationFreqStartIndex->setValue(
		qs.value("Export3DPlotImageSeries/AnimateFrequencyIndexStart", 0).toInt());
	ui->spinBox_AnimationFreqEndIndex->setValue(
		qs.value("Export3DPlotImageSeries/AnimateFrequencyIndexEnd", 0).toInt());
	ui->spinBox_AnimationChannelStartIndex->setValue(
		qs.value("Export3DPlotImageSeries/AnimateChannelIndexStart", 0).toInt());
	ui->spinBox_AnimationChannelEndIndex->setValue(
		qs.value("Export3DPlotImageSeries/AnimateChannelIndexEnd", 0).toInt());
	ui->doubleSpinBox_AnimationEleStart->setValue(
		qs.value("Export3DPlotImageSeries/AnimateElevatStart", 0.0f).toDouble());
	ui->doubleSpinBox_AnimationEleEnd->setValue(
		qs.value("Export3DPlotImageSeries/AnimateElevationEnd", 0.0f).toDouble());
}
