...
class DAFF_API Arrow : public DAFFViz::SGNode {
  public:
	 ...
	 */
	Arrow(DAFFViz::SGNode* pParentNode = NULL, double dTipLength = .15f, double dTipRadius = .06f,
		  int iTipResolution = 36, double dShaftRadius = .02f, int iShaftResolution = 36);
	virtual ~Arrow();
