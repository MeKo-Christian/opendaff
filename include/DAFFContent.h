...
class DAFF_API DAFFContent {
  public:
	 ...
	 *
	 */
	virtual void getNearestNeighbour(int iView, float fAngle1Deg, float fAngle2Deg, int& iRecordIndex,
									 bool& bOutOfBounds) const = 0;
	 ...
	 * Requested direction: alpha =  2&deg;, beta = 2&deg;	object view coordinate system (front direction would be
	 * 0&deg;,0&deg;) Resolution:			alpha = 10&deg;, beta = 5&deg; Index1 -> alpha =  0&deg;, beta = 0&deg;
	 * (object view) Index2 -> alpha =  0&deg;, beta = 5&deg; (object view) Index3 -> alpha = 10&deg;, beta = 5&deg;
	 * (object view) Index4 -> alpha = 10&deg;, beta = 0&deg; (object view)
	 *
	 * Special cases
	 *
	 ...
	 */
	virtual void transformAnglesD2O(float fAlphaDeg, float fBetaDeg, float& fAzimuthDeg,
									float& fElevationDeg) const = 0;
	 ...
	 */
	virtual void transformAnglesO2D(float fAzimuthDeg, float fElevationDeg, float& fAlphaDeg,
									float& fBetaDeg) const = 0;
};
