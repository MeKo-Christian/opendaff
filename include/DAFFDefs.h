...
enum DAFF_ERROR {
	...
	DAFF_FILE_CONTENT_INVALID_PARAMETER,   //!< Content parameter invalid (sampling rate, num supporting frequencies,
										   //!< etc)
...
class DAFF_API DAFFOrientationYPR {
  public:
	...
	//! Default constructor
	inline DAFFOrientationYPR() : fYawAngleDeg(0), fPitchAngleDeg(0), fRollAngleDeg(0) {};
	...
	inline DAFFOrientationYPR(float fInitYawAngleDeg, float fInitPitchAngleDeg, float fInitRollAngleDeg)
		: fYawAngleDeg(fInitYawAngleDeg), fPitchAngleDeg(fInitPitchAngleDeg), fRollAngleDeg(fInitRollAngleDeg) {};
