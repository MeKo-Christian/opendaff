...
CartesianCoordinateAssistant::CartesianCoordinateAssistant(SGNode* pParentNode, double LengthX, double LengthY,
														   double LengthZ)
	: SGNode(pParentNode), m_bGridVisible(true), m_bLabelsVisible(true), m_bAxesVisible(true),
	  m_bReferenceVisible(false), m_dMinX(0), m_dMaxX(1), m_dMinY(0), m_dMaxY(1), m_dMinZ(0), m_dMaxZ(1),
	  m_dResolutionX(.1), m_dResolutionY(.1), m_dResolutionZ(.1), m_dLengthX(LengthX), m_dLengthY(LengthY),
	  m_dLengthZ(LengthZ), m_dOffsetY(0)
{
	init();
}

CartesianCoordinateAssistant::CartesianCoordinateAssistant(double LengthX, double LengthY, double LengthZ)
	: SGNode(), m_bGridVisible(true), m_bLabelsVisible(true), m_bAxesVisible(true), m_bReferenceVisible(false),
	  m_dMinX(0), m_dMaxX(1), m_dMinY(0), m_dMaxY(1), m_dMinZ(0), m_dMaxZ(1), m_dResolutionX(.1), m_dResolutionY(.1),
	  m_dResolutionZ(.1), m_dLengthX(LengthX), m_dLengthY(LengthY), m_dLengthZ(LengthZ), m_dOffsetY(0)
{
	init();
}
...
double CartesianCoordinateAssistant::GetReferenceLevel() const
{
	return m_dReferenceLevel;
}
...
double CartesianCoordinateAssistant::GetReferenceOpacity() const
{
	return m_dReferenceAlpha;
}
...
void CartesianCoordinateAssistant::SetMinX(double min)
{
	m_dMinX = min;
}
