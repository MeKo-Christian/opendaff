...
SphericalCoordinateAssistant::SphericalCoordinateAssistant(SGNode* pParent, double dMin, double dMax, double dPrec,
														   double dScaleRes)
...
void SphericalCoordinateAssistant::SetReferenceLevel(double dLevel)
{
	m_dReferenceLevel = dLevel;
}

void SphericalCoordinateAssistant::SetReferenceOpacity(double dOpacity)
{
	m_dReferenceOpacity = dOpacity;
}

void SphericalCoordinateAssistant::SetMin(double min)
{
	m_dMin = min;
}

void SphericalCoordinateAssistant::SetMax(double max)
{
	m_dMax = max;
}

void SphericalCoordinateAssistant::SetRResolution(double prec)
{
	m_dPrecision = prec;
}

void SphericalCoordinateAssistant::SetPhiResolution(double res)
{
	m_dScaleRes = 360 / res;
}

double SphericalCoordinateAssistant::GetMin() const
{
	return m_dMin;
}

double SphericalCoordinateAssistant::GetMax() const
{
	return m_dMax;
}

double SphericalCoordinateAssistant::GetRResolution() const
{
	return m_dPrecision;
}

double SphericalCoordinateAssistant::GetPhiResolution() const
{
	return 360 / m_dScaleRes;
}
