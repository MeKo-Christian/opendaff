...
Plane::Plane(SGNode* pParentNode) : SGNode(pParentNode), m_pSource(NULL), m_pMapper(NULL), m_pActor(NULL)
{
	init();
}

Plane::Plane(SGNode* pParentNode, double x1, double y1, double z1, double x2, double y2, double z2, double n1,
			 double n2, double n3)
