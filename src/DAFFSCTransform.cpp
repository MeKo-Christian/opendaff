...
void DAFFSCTransform::transformOSC2DSC(double azimuth_in, double elevation_in, double& alpha_out,
									   double& beta_out) const
{
...
void DAFFSCTransform::transformDSC2OSC(double alpha_in, double beta_in, double& azimuth_out,
									   double& elevation_out) const
{
	// Internally in this method we use radians (not degrees)
	double ai = DAFFUtils::grad2rad(alpha_in),
		   ei = DAFFUtils::grad2rad(beta_in - 90.0F);  // Translate into OSC (e=b-90)
	double ao, eo;
