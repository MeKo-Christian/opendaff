...
void stc_sint16_to_float_add(float* dest, const short* src, size_t count, int input_stride, int output_stride,
							 float gain)
{
	float c = gain / 32767.0F;
	for (size_t i = 0; i < count; i++)
...
void stc_sint24_to_float_add(float* dest, const void* src, size_t count, int input_stride, int output_stride,
							 float gain)
{
	const unsigned char* p = (const unsigned char*)src;
